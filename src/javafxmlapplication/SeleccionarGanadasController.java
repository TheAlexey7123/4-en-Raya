 ...
 * @author Usuario
 */
public class SeleccionarGanadasController implements Initializable {
    ...
    private void buscar(ActionEvent event) {
        ...
        // Obtener las partidas ganadas dentro del rango de fechas
        List<Round> partidasGanadas = sistema.getRoundsForPlayer(nickName)
                .stream()
                .filter(round -> round.getWinner().getNickName().equals(nickName)) // Solo partidas ganadas
        ...
        mostrarPartidas(partidasGanadas, FechaInicio, FechaFin);
    }
    ...
    private void mostrarPartidas(List<Round> partidas, LocalDate fechaInicio, LocalDate fechaFin) {
        try {
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("VerGanadas.fxml"));
            javafx.scene.Parent root = loader.load();

            VerGanadasController controller = loader.getController();
            controller.cargarDatos(partidas, fechaInicio.atStartOfDay(), fechaFin.atTime(23, 59, 59));
            controller.setPlayerNickname(nickName2);

            Stage stage = (Stage) buttonBuscar.getScene().getWindow();
    ...
    private void regresar(ActionEvent event) {
        ...
        rankingController.initializeWithNickname(this.nickName2);
    ...
    public void setPlayerNickname(String playerNickname) {
        nickName2 = playerNickname; // Actualizar la etiqueta con el nickname
    }
}    
